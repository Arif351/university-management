...
const createSemester = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const academicSemesterDate = __rest(req.body, []);
    const result = yield academicSemester_service_1.academicSemesterService.createSemester(academicSemesterDate);
...
const getAllSemester = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(req.query, academicSemester_constant_1.academicSemesterFiterableField);
