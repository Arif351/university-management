...
const getAllStudents = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { page, limit, skip, sortBy, sortOrder } = paginationHelper_1.paginationHelpers.calculatePagintions(paginationOptions);
    const sortCondition = {};
    if (sortBy && sortOrder) {
...
const updateStudents = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExits) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Student did not found.');
    }
